    ...
    <>
      ...
      <main className="flex flex-col items-center mt-12 w-full">
        ...
        <div className="flex flex-row text-base m-4 text-white justify-between w-[80%] text-center">
          <div className="flex flex-col w-[17rem] p-4 bg-[--trinary] rounded-md items-center h-[300px] space-y-4">
            <span className="border-white border-2 text-3xl rounded-full px-3 m-2 text-center font-bold">
              1
            </span>
